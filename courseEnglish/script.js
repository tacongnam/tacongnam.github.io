...
function checkPart(id) {
    ...
    if (countCorrect == endId - startId + 1) {
        ...
        document.getElementsByTagName("button")[id + pre_button].disabled = true;
        document.getElementsByTagName("button")[id + pre_button].style.backgroundColor = "green";
        if (isLastRun == false)
        ...
        document.getElementsByTagName("button")[id + pre_button].style.backgroundColor = "red";
        if (isLastRun == false)
